...
public class Ced_MultiVendor_UpsellProductAdapter extends BaseAdapter
{
    ...
    public Ced_MultiVendor_UpsellProductAdapter(Activity a, ArrayList<HashMap<String, String>> d)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        {
            if(Ced_MultiVendor_GlobalVariables.upsellproductids.contains(holder.product_id.getText()))
            {
                holder.selectrelated.setChecked(true);
            }
            else
        ...
        holder.selectrelated.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener()
        {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                if(isChecked)
                {
                    if(!(Ced_MultiVendor_GlobalVariables.upsellproductids.contains(holder.product_id.getText().toString())))
                    {
                        Ced_MultiVendor_GlobalVariables.upsellproductids.add(holder.product_id.getText().toString());
                    }
                ...
                else
                {
                    if((Ced_MultiVendor_GlobalVariables.upsellproductids.contains(holder.product_id.getText().toString())))
                    {
                        Ced_MultiVendor_GlobalVariables.upsellproductids.remove(holder.product_id.getText().toString());
                    }
                }
