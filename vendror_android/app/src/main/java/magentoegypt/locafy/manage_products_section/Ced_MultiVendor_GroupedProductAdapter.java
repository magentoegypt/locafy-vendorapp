...
public class Ced_MultiVendor_GroupedProductAdapter extends BaseAdapter {
    ...
    public Ced_MultiVendor_GroupedProductAdapter(Activity a, ArrayList<HashMap<String, String>> d) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi = convertView;
        if (vi == null) {
            vi = inflater.inflate(R.layout.ced_multivendor_groupedproductlist, null);
        ...
        if (Ced_MultiVendor_GlobalVariables.groupedproductids.size() > 0) {
            if (Ced_MultiVendor_GlobalVariables.groupedproductids.contains(holder.product_id.getText())) {
                holder.selectrelated.setChecked(true);
            } else {
                holder.selectrelated.setChecked(false);
            }
        ...
        holder.selectrelated.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    if (!(Ced_MultiVendor_GlobalVariables.groupedproductids.contains(holder.product_id.getText().toString()))) {
                        Ced_MultiVendor_GlobalVariables.groupedproductids.add(holder.product_id.getText().toString());
                    }

                } else {
                    if ((Ced_MultiVendor_GlobalVariables.groupedproductids.contains(holder.product_id.getText().toString()))) {
                        Ced_MultiVendor_GlobalVariables.groupedproductids.remove(holder.product_id.getText().toString());
                    }
                }
        ...
        holder.qty.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                try {
                    ...
                    Ced_MultiVendor_GlobalVariables.grpupedproductqty.put(parts[1], holder.qty.getText().toString());
