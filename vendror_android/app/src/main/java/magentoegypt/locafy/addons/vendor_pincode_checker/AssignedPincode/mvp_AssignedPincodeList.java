package magentoegypt.locafy.addons.vendor_pincode_checker.AssignedPincode;
...
import magentoegypt.locafy.addons.vendor_pincode_checker.PincodeList.mvp_PincodeList_Adapter;
...
public class mvp_AssignedPincodeList extends Ced_MultiVendor_NavigationActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getPincodeList_url = session.getBase_Url() + "rest/V1/pcapi/getAssignedPincodeList";
        ...
        if (connectionDetector.isConnectingToInternet()) {
            ...
            getLayoutInflater().inflate(R.layout.activity_assigned_pincode_list, content, true);
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setHomeAsUpIndicator(R.drawable.backbutton);
            recyclerView_storeList = findViewById(R.id.assigned_pincode_list);
...
//            storeHashmap.put("hashkey", getResources().getString(R.string.header));
                    ...
                    try {
                        ...
                        if (status.equals("true")) {
                            ...
                            for (int i = 0; i < storelist.length(); i++) {
                                ...
                                store_data.put("allowed_id", store.getString("id"));
                            ...
                            Store_Adapter = new mvp_PincodeList_Adapter(mvp_AssignedPincodeList.this, StoreArraylist);
                            ...
                            recyclerView_storeList.addOnScrollListener(new RecyclerView.OnScrollListener() {
                                ...
                                public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                                    ...
                                    if (!recyclerView.canScrollVertically(1) && paginate) {
                                        ...
                                        }, mvp_AssignedPincodeList.this, "POST", storeHashmap.toString(), false, true);
                                        scroll_request.execute(getPincodeList_url);
                                    }
                                }
                            });
                        } else {
                            Toast.makeText(mvp_AssignedPincodeList.this, data.getString("message"), Toast.LENGTH_SHORT).show();
                        }
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
    ...
    private void showfilter() {
        try {
            ...
            final EditText zipcode = v.findViewById(R.id.MultiVendor_zipcode);
            final Spinner canship = v.findViewById(R.id.MultiVendor_canship);
            final Spinner cancod = v.findViewById(R.id.MultiVendor_cancod);
            final EditText daystodeliver = v.findViewById(R.id.MultiVendor_daystodeliver);
            ...
            unsetfilter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mvp_AssignedPincodeList.this, mvp_AssignedPincodeList.class);
            ...
            setfilter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        Intent intent = new Intent(getApplicationContext(), mvp_AssignedPincodeList.class);
    ...
    public void scrolldata(String string) {
        try {
            ...
            if (status.equals("true")) {
                ...
                mvp_PincodeList_Adapter adapter = new mvp_PincodeList_Adapter(mvp_AssignedPincodeList.this, StoreArraylist);
                RecyclerView.LayoutManager mLayoutManager = new LinearLayoutManager(mvp_AssignedPincodeList.this);
                recyclerView_storeList.setLayoutManager(mLayoutManager);
