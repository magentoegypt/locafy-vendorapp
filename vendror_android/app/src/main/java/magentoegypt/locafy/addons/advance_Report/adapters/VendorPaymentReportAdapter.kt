...
class VendorPaymentReportAdapter(private val loadMore: AddOnScrollMoreListener) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        ...
        val binding: PaymentReportViewBinding = PaymentReportViewBinding.inflate(
            inflater, parent,
            false
        )
    ...
    override fun onBindViewHolder(holder: AppViewHolder, position: Int) {
        try {
            ...
            holder.paymentReport.product = product
            holder.paymentReport.transactionDate.text = convertToEgyptTimeZone(product.transactionDate);
        }
        catch (e: Exception) {
