...
import magentoegypt.locafy.addons.inventory.adapters.OutOfStockProductAdapter;
...
public class OutOfStockActivity extends Ced_MultiVendor_NavigationActivity implements EditAndDeleteListener {
    ...
    OutOfStockProductAdapter adapter;
    TextView text_msg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (connectionDetector.isConnectingToInternet()) {
            ...
            getLayoutInflater().inflate(R.layout.activity_out_of_stock, content, true);
            ...
            pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ...
                    Intent intent = new Intent(OutOfStockActivity.this, OutOfStockActivity.class);
    ...
    private void bindAdapter() {
        adapter = new OutOfStockProductAdapter(this);
    ...
    private void init() {
        ...
        cedNewLoader = new Ced_NewLoader(OutOfStockActivity.this);
        viewModel = ViewModelProviders.of(OutOfStockActivity.this).get((InventoryViewModel.class));

        viewModel.observeLowStockData().observe(OutOfStockActivity.this, this::handleResponse);

        viewModel.error.observe(OutOfStockActivity.this, s -> Toast.makeText(OutOfStockActivity.this, s, Toast.LENGTH_SHORT).show());

        viewModel.loading.observe(OutOfStockActivity.this, this::updateLoader);
    }
    ...
    private void editProduct(JSONObject obj) throws JSONException {
        ...
        Ced_MultiVendor_ClientRequestResponse crr = new Ced_MultiVendor_ClientRequestResponse(output -> {
            ...
            if (functionalityList.getExtensionAddon()) {
                ...
                if (success.equals("true")) {
                    ...
                    Intent update = new Intent(OutOfStockActivity.this, EditProductDynamic.class);
                ...
                Intent intent = new Intent(OutOfStockActivity.this, Ced_MultiVendor_UnAuthourizedRequestError.class);
        ...
        }, OutOfStockActivity.this, "POST", dataforproducts);
    ...
    public void showFilterDialog() {
        final View filter_dialog = OutOfStockActivity.this.getLayoutInflater().inflate(R.layout.inventory_filter_screen, null);
        final AlertDialog.Builder alert = new AlertDialog.Builder(OutOfStockActivity.this);
