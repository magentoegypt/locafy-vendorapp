...
public class Ced_MultiVendor_ProductListSelectNSellAdapter extends BaseAdapter {
    ...
    public Ced_MultiVendor_ProductListSelectNSellAdapter(Activity product_list, ArrayList<HashMap<String, String>> d) {
        fontSetting = new Ced_MultiVendor_FontSetting();
        activity = product_list;
        data = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (vi == null) {
            ...
            viewHolder.Productypetag.setVisibility(View.GONE);
            ...
            viewHolder.delete = (TextView) vi.findViewById(R.id.MultiVendor_delete);
            ...
            viewHolder.Productype.setVisibility(View.GONE);
            ...
            viewHolder.website = (TextView) vi.findViewById(R.id.MultiVendor_website_text);
