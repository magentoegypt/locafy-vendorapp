...
public class OutOfStockProductAdapter extends RecyclerView.Adapter<OutOfStockViewHolder> {
    List<JSONObject> list = new ArrayList<>();
    EditAndDeleteListener editAndDeleteListener;

    public OutOfStockProductAdapter(EditAndDeleteListener editAndDeleteListener) {
    ...
    public void onBindViewHolder(@NonNull OutOfStockViewHolder appViewHolder, int i) {
        ...
        appViewHolder.name.setText(getTextFromObject(jsonObject, "product_name"));
        appViewHolder.type.setText(getTextFromObject(jsonObject, "product_type"));
        appViewHolder.price.setText(getTextFromObject(jsonObject, "vendor_price"));
        appViewHolder.quantity.setText(getTextFromObject(jsonObject, "quantity"));
      //  appViewHolder.tag.setText("Sku");
