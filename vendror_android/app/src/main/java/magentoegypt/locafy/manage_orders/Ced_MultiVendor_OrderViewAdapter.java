...
public class Ced_MultiVendor_OrderViewAdapter extends BaseAdapter {
    ...
    public Ced_MultiVendor_OrderViewAdapter(Activity orderview, ArrayList<HashMap<String, String>> orderinfo) {
        act=orderview;
        data=orderinfo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        prod_name.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_PRODUCT_NAME));
        prod_price.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_PRODUCT_PRICE));
        prod_qty.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_PRODUCT_QTY));
        prod_sku.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_PRODUCT_SKU));
        Subtotal.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_ROW_SUB_TOTAL));
        TaxAmount.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_TAX_AMOUNT));
        DiscountAmount.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_DISCOUNT_AMOUNT));
        RowTotal.setText(order_prodlisting.get(Ced_MultiVendor_Orderview.KEY_ROW_TOTAL));
