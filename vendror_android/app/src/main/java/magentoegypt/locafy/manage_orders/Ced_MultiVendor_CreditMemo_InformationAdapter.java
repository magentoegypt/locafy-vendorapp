 ...
 */
public class Ced_MultiVendor_CreditMemo_InformationAdapter extends BaseAdapter {
    private static LayoutInflater inflater = null;
    Activity act;
    Ced_MultiVendor_FontSetting fontSetting;
    private final ArrayList<HashMap<String, String>> data;

    public Ced_MultiVendor_CreditMemo_InformationAdapter(Activity creditMemo_information, ArrayList<HashMap<String, String>> invoiceinfo) {
        act = creditMemo_information;
        data = invoiceinfo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Invoice_id_txt.setText(act.getResources().getString(R.string.CreditMemoid));
        invoice_date_txt.setText(act.getResources().getString(R.string.CreditMemo_date));
        Amount_text.setText(act.getResources().getString(R.string.Subtotal));
        ...
        Invoice_id.setText(invoicelisting.get(Ced_MultiVendor_CreditMemo_Information.KEY_INCREMENT_ID));
        invoice_date.setText(invoicelisting.get(Ced_MultiVendor_CreditMemo_Information.KEY_CREATED_AT));
        prodname.setText(invoicelisting.get(Ced_MultiVendor_CreditMemo_Information.KEY_BILLING_NAME));
        status.setText(invoicelisting.get(Ced_MultiVendor_CreditMemo_Information.KEY_STATE));
        Amount.setText(invoicelisting.get(Ced_MultiVendor_CreditMemo_Information.KEY_GRAND_TOTAL));
