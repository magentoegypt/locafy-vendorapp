 ...
 */
public class Ced_MultiVendor_CreateInvoice extends Ced_MultiVendor_NavigationActivity {
    ...
    String statusLabel, storeName, orderStoreDate, header_meassage, CustomerName, CustomerEmail,
            ...
            order_shipping, order_tax, item_id, creater_shipment;
    TextView orderdate_head, orderDate, order_status_head, OrderStatus,
            ...
            RefundShipping_head, RefundShipping, AdjustmentFee, AdjustmentRefund;
    Button order_increment_id, ProductInfo_head, refund_offline_button, InvoiceTotals, add_tracking;
    EditText add_comment;
    ArrayList<LinkedHashMap<String, String>> Invoiceinfo;
    ArrayList<HashMap<String, String>> dyanmicinfo, dynamic_comment_list;
    Ced_MultiVendor_CreateInvoiceAdapter createCreditMemoAdapter;
    ...
    CardView view11;
    LinearLayout account_info_dynamic, dynamic_comment, dynamic_listing, dynamic_shipping_carrier, add_shipment_carrier, Shipping_Address_linear;
    CheckBox chck_email_copy, chck_append_comments, CreateShipment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Shippinglabellist = new ArrayList<>();
        Shippingvaluelist = new ArrayList<>();
        if (connectionDetector.isConnectingToInternet()) {
            ViewGroup content = findViewById(R.id.MultiVendor_frame_container);
            getLayoutInflater().inflate(R.layout.ced_multivendor_activity_create_invoice_view, content, true);
            ...
            dynamic_shipping_carrier = findViewById(R.id.MultiVendor_dynamic_shipping_carrier);
            ...
            InvoiceTotals.setText(getResources().getString(R.string.InvoiceTotal));
            ProductInfo_head.setText(getResources().getString(R.string.ItemstoInvoice));
...
/*            AdjustmentFee_head = (TextView) findViewById(R.id.MultiVendor_CommissionFee);
            AdjustmentFee = (EditText) findViewById(R.id.MultiVendor_AdjustmentFee);*/
            ...
            AdjustmentRefund_head.setVisibility(GONE);
            AdjustmentRefund.setVisibility(GONE);
            ...
            CreateShipment = findViewById(R.id.MultiVendor_CreateShipment);
            ...
            creditsave_url = session.getBase_Url() + "vorderapi/vinvoice/save";
            post_id = getIntent().getStringExtra("order_id");
            postdata.put("order_id", post_id);
            postdata.put("type", "invoice");
//            postdata.put("do_shipment", "false");
            ...
            chck_append_comments.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (chck_append_comments.isChecked()) {
                    ...
                    postdata.put("comment_customer_notify", "false");
                }
            });
            CreateShipment.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (CreateShipment.isChecked()) {
                    postdata.put("do_shipment", "true");
                    add_shipment_carrier.setVisibility(View.VISIBLE);
                }
                else {
                    postdata.put("do_shipment", "false");
                    add_shipment_carrier.setVisibility(GONE);
                }
            });
            add_tracking.setOnClickListener(v -> {
                View tracking_view = View.inflate(Ced_MultiVendor_CreateInvoice.this, R.layout.ced_multivendor_dynamic_shiping_carrier, null);
                final EditText Carrier = tracking_view.findViewById(R.id.MultiVendor_Carrier);
                final EditText Title = tracking_view.findViewById(R.id.MultiVendor_Title);
                final EditText Number = tracking_view.findViewById(R.id.MultiVendor_Number);
                final Button delete_tracking = tracking_view.findViewById(R.id.MultiVendor_delete_tracking);
                final TextView carrier_values = tracking_view.findViewById(R.id.MultiVendor_carrier_value);
                ...
                Carrier.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Dialog levelDialog1 = new Dialog(Ced_MultiVendor_CreateInvoice.this);
                        final AlertDialog.Builder builder = new AlertDialog.Builder(Ced_MultiVendor_CreateInvoice.this);
            ...
            refund_offline_button.setOnClickListener(v -> {
                ...
                for (int i = 0; i < dynamic_listing.getChildCount(); i++) {
                    ...
                    LinearLayout ordered_quantity = (LinearLayout) linearLayout1.getChildAt(3);
                    TextView order_qty = (TextView) ordered_quantity.getChildAt(1);
                    TextView Itemid = (TextView) linearLayout1.getChildAt(10);
                    TextView remaining = (TextView) linearLayout1.getChildAt(11);
                    LinearLayout linearLayout2 = (LinearLayout) linearLayout1.getChildAt(5);
                    EditText quantity = (EditText) linearLayout2.getChildAt(1);

                    qty_error = Integer.valueOf(remaining.getText().toString()) < Integer.valueOf(quantity.getText().toString());
                ...
                if (!qty_error) {
                    ...
                    Toast.makeText(getApplicationContext(), "Invoiced Quantity cannot be greater than Ordered Quantity", Toast.LENGTH_LONG).show();
                }
    ...
    private void create_new() {
            ...
            public void processFinish(Object output) throws JSONException {
                if (functionalityList.getExtensionAddon()) {
                    ...
                    if (object.getJSONObject("data").getBoolean("success")) {
                        ...
                        Intent back_intent = new Intent(Ced_MultiVendor_CreateInvoice.this, Ced_MultiVendor_ManageOrderview.class);
        ...
        }, Ced_MultiVendor_CreateInvoice.this, "POST", postdata);
    ...
    private void createcreditmemoviewdata() throws JSONException {
        ...
        if (jsonObject.has("vendor_approved")) {
            ...
            if (jsonObject.getJSONObject("data").getBoolean("success")) {
                ...
                /*    RefundShipping_head.setVisibility(c.has("shipment_handled") ? View.VISIBLE : View.GONE);
...
*/
                    ...
                    if (c.has("name")) {
                        ...
                        Shipping_Address_linear.setVisibility(GONE);
                    }
                    bill_to = c.getString("bill_name");
                    bill_street = c.getString("bill_street");
                    creater_shipment = c.getString("create_shipment");
                    ...
                    for (int j = 0; j < items.length(); j++) {
                        ...
                        add_shiping_items.put(name + "#" + sku + "#" + price + "#" + qty_ordered + "#" + qty_shipped + "#" + discount_amount + "#" + tax_amount + "#" + row_total + "#" + subtotal + "#" + item_id + "#" + qty_invoiced, Invoiceinfo);
                    }

                    Iterator iterator4 = add_shiping_items.entrySet().iterator();
                    while (iterator4.hasNext()) {
                        View view_itemtoship = View.inflate(this, R.layout.ced_multivendor_dynamic_items_to_invoice, null);
                        ...
                        prod_qty_ship.setText(String.valueOf(Integer.valueOf(parts[3]) - Integer.valueOf(parts[10])));
                        remaining_quantity.setText(String.valueOf(Integer.valueOf(parts[3]) - Integer.valueOf(parts[10])));
...
//                grandtotalearned.setText(order_total);
                ...
                AdjustmentRefund.setText(order_tax);
                if (creater_shipment.equals("false")) {
                    CreateShipment.setVisibility(GONE);
                }
                /*RefundShipping.setText(order_shipping);*/
