 ...
 */
public class Ced_MultiVendor_CreditMemo_Information extends Ced_MultiVendor_NavigationActivity {
    ...
    Ced_MultiVendor_CreditMemo_InformationAdapter invoice_informationAdapter;
    TextView txt_empty;
        ...
        if (connectionDetector.isConnectingToInternet()) {
            ...
            pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ...
                    Intent intent = new Intent(Ced_MultiVendor_CreditMemo_Information.this, Ced_MultiVendor_CreditMemo_Information.class);
            ...
            url = session.getBase_Url() + "vorderapi/vorders/viewCreditmemo";
    ...
    private void request() {
        ...
        }, Ced_MultiVendor_CreditMemo_Information.this, "POST", postdata);
    ...
    private void creditmemoviewdata() throws JSONException {
        ...
        if (jsonObject.has("vendor_approved")) {
            ...
            if (jsonObject.getJSONObject("data").getBoolean("success")) {
                invoice = jsonObject.getJSONObject("data").getJSONArray("creditmemo");
                ...
                invoice_informationAdapter = new Ced_MultiVendor_CreditMemo_InformationAdapter(Ced_MultiVendor_CreditMemo_Information.this, Invoiceinfo);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        invoice_info_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                ...
                                Intent orderview = new Intent(Ced_MultiVendor_CreditMemo_Information.this, Ced_MultiVendor_CreditMemoView.class);
                                orderview.putExtra("creditmemo_id", invoice_id);
