...
/**
 * Created by developer on 24/6/16.
 */
//Invoice View Screen
public class Ced_MultiVendor_InvoiceView extends Ced_MultiVendor_NavigationActivity {
    ...
    static final String IGST_AMT = "igstAmt";
    static final String SGST_AMT = "sgstAmt";
    static final String CGST_AMT = "cgstAmt";
    ...
    JSONArray invoicedata, items, account_data, comments, buttons;
    String statusLabel, storeName, orderStoreDate, header_meassage, CustomerName, CustomerEmail,
            ...
            subtotal, label, value, date_time,
            notified, comment, shipping_method, shipping_price,
            order_subtotal, order_commission, net_earn, shippingPrice,order_shipping, order_tax, order_discount;
    TextView orderdate_head, orderDate, order_status_head, OrderStatus,
            ...
            CreditCardNumber_head, CreditCardNumber, NameontheCard_head,
            NameontheCard, shipping_amount, ShippingMethod, Subtotal, grandtotals, grandtotalearned, CommissionFee,
            ...
            ShippingAndHandling, ShippingAndHandling_head, MessageAtLast;
    Button order_increment_id, InvoiceTotals, ProductInfo_head, new_generate;
    String igstAmt = "N/A", sgstAmt = "N/A", cgstAmt = "N/A";


    ArrayList<HashMap<String, String>> Invoiceinfo;
    ArrayList<HashMap<String, String>> dyanmicinfo, dynamic_comment_list;
    Ced_MultiVendor_InvoiceViewAdapter invoiceViewAdapter;
    ...
    LinearLayout account_info_dynamic, dynamic_comment, GrandTotalEarned_Linear, CommissionFee_linear, netEarned_linear;
    List buttonlabellist;
    ImageView generate_button;
    String button_label, order_id;
    CardView MultiVendor_view4,commentCard;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (connectionDetector.isConnectingToInternet()) {
            ...
            MultiVendor_view4 = findViewById(R.id.MultiVendor_view4);
            ...
            new_generate = findViewById(R.id.MultiVendor_new_generate);
            ...
            ProductInfo_head.setText(getResources().getString(R.string.ItemsInvoiced));
            ...
            TaxAmount_head.setVisibility(View.GONE);
            ...
            url = session.getBase_Url() + "vorderapi/vinvoice/view";
            post_id = getIntent().getStringExtra("invoice_id");
            postdata.put("invoice_id", post_id);
            fab = findViewById(R.id.MultiVendor_fab);
            new_generate.setOnClickListener(v -> {
                AppConstant.lockButton(v);
                Intent create_attribute = new Intent(Ced_MultiVendor_InvoiceView.this, Ced_MultiVendor_CreateCreditMemo.class);
                create_attribute.putExtra("invoice_id", post_id);
                startActivity(create_attribute);
                overridePendingTransition(R.anim.ced_multivendor_slide_in, R.anim.ced_multivendor_slide_out);
            });
            fab.setOnClickListener(v -> {
                AppConstant.lockButton(v);
                Intent create_attribute = new Intent(Ced_MultiVendor_InvoiceView.this, Ced_MultiVendor_CreateComment.class);
                create_attribute.putExtra("invoice_id", post_id);
                startActivity(create_attribute);
                overridePendingTransition(R.anim.ced_multivendor_slide_in, R.anim.ced_multivendor_slide_out);
            });
            generate_button.setOnClickListener(v -> {
                AppConstant.lockButton(v);
                final CharSequence[] arrayOfInt2 = (CharSequence[]) buttonlabellist.toArray(new CharSequence[buttonlabellist.size()]);

                Dialog levelDialog1 = new Dialog(Ced_MultiVendor_InvoiceView.this);
                final AlertDialog.Builder builder = new AlertDialog.Builder(Ced_MultiVendor_InvoiceView.this);
                ...
                builder.setSingleChoiceItems(arrayOfInt2, -1, (dialog, postion) -> {
                            ...
                            if (button_label.equals("creditmemo")) {
                                Intent credit_intent = new Intent(Ced_MultiVendor_InvoiceView.this, Ced_MultiVendor_CreateCreditMemo.class);
                                credit_intent.putExtra("order_id", order_id);
                                credit_intent.putExtra("invoice_id", post_id);
    ...
    private void request() {
        ...
        }, Ced_MultiVendor_InvoiceView.this, "POST", postdata);
    ...
    private void invoiceviewdata() throws JSONException {
        ...
        if (jsonObject.has("vendor_approved")) {
            ...
            if (jsonObject.getJSONObject("data").getBoolean("success")) {
                ...
                invoicedata = jsonObject.getJSONObject("data").getJSONArray("invoicedata");
                ...
                for (int i = 0; i < invoicedata.length(); i++) {
                    ...
                    if (c.has("name")) {
                        ...
                        MultiVendor_view4.setVisibility(View.VISIBLE);
                    ...
                    if (c.has("shipment_handled")&&c.getString("shipment_handled").equals("vendor")) {
                        ...
                        if (c.has("shipping_price")&&!c.getString("shipping_price").equals("")) {
                            view11.setVisibility(View.VISIBLE);
                        }
                    }
                    else {
                    ...
                    if (c.has("order_tax")) {
                        TaxAmount_head.setVisibility(View.VISIBLE);
                    ...
                    if (items.length() > 0) {
                        invoice_view_list.setAdapter(new CommanViewAdapter(items, Ced_MultiVendor_InvoiceView.this));
