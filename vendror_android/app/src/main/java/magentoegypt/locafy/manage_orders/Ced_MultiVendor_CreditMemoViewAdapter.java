 ...
 */
public class Ced_MultiVendor_CreditMemoViewAdapter extends BaseAdapter {
    private Context act;
    private ArrayList<HashMap<String, String>> data;
    private static LayoutInflater inflater = null;
    Ced_MultiVendor_FontSetting fontSetting;

    public Ced_MultiVendor_CreditMemoViewAdapter(Activity creditMemoView, ArrayList<HashMap<String, String>> invoiceinfo) {
        data = invoiceinfo;
        act = creditMemoView;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        prod_name.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_NAME));
        prod_price.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_PRICE));
        prod_qty.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_QTY));
        prod_sku.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_SKU));
        Subtotal.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_SUBTOTAL));
        TaxAmount.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_TAX_AMOUNT));
        DiscountAmount.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_DISCOUNT));
        RowTotal.setText(order_prodlisting.get(Ced_MultiVendor_CreditMemoView.KEY_ROW_TOTAL));
