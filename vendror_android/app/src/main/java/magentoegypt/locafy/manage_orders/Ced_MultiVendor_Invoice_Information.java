 ...
 */
public class Ced_MultiVendor_Invoice_Information extends Ced_MultiVendor_NavigationActivity {
    ...
    String created_at, increment_id, state, grand_total, billing_name;
    ArrayList<HashMap<String, String>> Invoiceinfo;
    Ced_MultiVendor_Invoice_InformationAdapter invoice_informationAdapter;
    TextView txt_empty;
...
// finally change the color
        ...
        if (connectionDetector.isConnectingToInternet()) {
            ...
            pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                ...
                public void onRefresh() {
                    ...
                    Intent intent = new Intent(Ced_MultiVendor_Invoice_Information.this, Ced_MultiVendor_Invoice_Information.class);
            ...
            invoice_info_list = (ListView) findViewById(R.id.MultiVendor_invoice_info_list);
            txt_empty = (TextView) findViewById(R.id.MultiVendor_txt_empty);
            ...
            url =session.getBase_Url()+ "vorderapi/vorders/viewInvoice";
    ...
    private void request() {
        ...
        }, Ced_MultiVendor_Invoice_Information.this, "POST", postdata);
    ...
    private void invoiceviewdata() throws JSONException {
        ...
        if (jsonObject.has("vendor_approved")) {
            ...
            if (jsonObject.getJSONObject("data").getBoolean("success")) {
                invoice = jsonObject.getJSONObject("data").getJSONArray("invoice");
                ...
                invoice_informationAdapter = new Ced_MultiVendor_Invoice_InformationAdapter(Ced_MultiVendor_Invoice_Information.this, Invoiceinfo);
                ...
                invoice_info_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        TextView Invoice_id = (TextView) view.findViewById(R.id.MultiVendor_Invoice_id);
                        String invoice_id = Invoice_id.getText().toString();
                        Intent orderview = new Intent(Ced_MultiVendor_Invoice_Information.this, Ced_MultiVendor_InvoiceView.class);
