 ...
 */
public class Ced_MultiVendor_Shipment_InformationAdapter extends BaseAdapter {
    private static LayoutInflater inflater = null;
    Activity act;
    Ced_MultiVendor_FontSetting fontSetting;
    private final ArrayList<HashMap<String, String>> data;

    public Ced_MultiVendor_Shipment_InformationAdapter(Activity shipment_information, ArrayList<HashMap<String, String>> invoiceinfo) {
        act = shipment_information;
        data = invoiceinfo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout status_linear = (LinearLayout) convertView.findViewById(R.id.MultiVendor_status_linear);
        status_linear.setVisibility(View.GONE);
        Amount_text.setText(act.getString(R.string.Quantity));
        invoice_date_txt.setText(act.getString(R.string.shipment_date));
        ...
        Invoice_id_txt.setText(act.getResources().getString(R.string.Shipment_id));
        HashMap<String, String> invoicelisting = new HashMap<String, String>();
        invoicelisting = data.get(position);

        Invoice_id.setText(invoicelisting.get(Ced_MultiVendor_Shipment_Information.KEY_INCREMENT_ID));
        invoice_date.setText(invoicelisting.get(Ced_MultiVendor_Shipment_Information.KEY_CREATED_AT));
        prodname.setText(invoicelisting.get(Ced_MultiVendor_Shipment_Information.KEY_BILLING_NAME));

        Amount.setText(invoicelisting.get(Ced_MultiVendor_Shipment_Information.KEY_GRAND_TOTAL));
