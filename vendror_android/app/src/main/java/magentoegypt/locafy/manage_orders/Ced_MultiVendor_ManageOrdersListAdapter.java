 ...
 */
public class Ced_MultiVendor_ManageOrdersListAdapter extends BaseAdapter {
    private static LayoutInflater inflater = null;
    Activity act;
    Ced_MultiVendor_FontSetting fontSetting;
    private final ArrayList<HashMap<String, String>> data;

    public Ced_MultiVendor_ManageOrdersListAdapter(Activity manageOrdersList, ArrayList<HashMap<String, String>> orderinfo) {
        act = manageOrdersList;
        data = orderinfo;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        date.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_CREATED_AT));
        prod_name.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_BILLING_NAME));
        order_id.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_ORDER_ID));
        status.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_ORDER_PAYMENT_STATE));
        amount.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_GRAND_TOTAL));
        commission_amount.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_COMMISSION));
        netearned.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_NET_Earned));
        vendorpaymentstatus.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_PAYMENT_STATE));
        order_primaryid.setText(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_ID));
        if (!(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_STORE_NAME) == null)) {
            storename.setText(Html.fromHtml(orderlisting.get(Ced_MultiVendor_ManageOrdersList.KEY_STORE_NAME)));
        } else {
