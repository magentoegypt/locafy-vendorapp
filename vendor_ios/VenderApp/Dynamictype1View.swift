...
class Dynamictype1View: UIView {
    ...
    @IBOutlet weak var maxCharValue: UITextView!
    ...
    @objc func xibSetup()
    {
        ...
        PopupLookImprovement.designTextView(maxCharValue);
        //designing code
    ...
    @objc func loadViewFromNib() -> UIView
    {
        ...
        let nib = UINib(nibName: "Dynamictype1View", bundle: bundle)
