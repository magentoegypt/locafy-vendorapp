...
class cedSoldProducts: ced_VendorBaseClass, UITableViewDelegate, UITableViewDataSource, UIGestureRecognizerDelegate, UITextFieldDelegate {
    ...
    lazy var filterView:SoldProductsFilterView = {
        let view = SoldProductsFilterView()
    ...
    override func viewDidLoad() {
        ...
        headingLabel.text = "Sold Products".localized
    ...
    @objc func loadProducts()
    {
       ...
       // self.sendRequest(url: "vreportapi/product/soldproduct", parameters: postString)
        ...
        self.sendRequestWithData(url: "rest/V1/vreport/getSoldProduct", params: param)
    }
    ...
    override func recieveResponse(data: Data?, requestUrl: String?, response: URLResponse?) {
        ...
        if let data = data{
                ...
                
            {
                ...
                {
                    products.append(["Sku":prod["sku"].stringValue,"Product Name":prod["product_name"].stringValue,"Product Type":prod["product_type"].stringValue,"ordered_qty":prod["ordered_qty"].stringValue])
                }
    ...
    @objc func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = tableView.dequeueReusableCell(withIdentifier: "cedOutOfStockCell", for: indexPath) as? cedOutOfStockCell
        {
            ...
            cell.quantity.text = prod["ordered_qty"];
