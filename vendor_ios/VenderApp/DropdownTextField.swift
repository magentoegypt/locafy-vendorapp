...
class DropdownTextField : UITextField{
    ...
    @IBInspectable public var tableWidth: CGFloat = 0
    @IBInspectable public var rowBackgroundColor: UIColor = .white
    @IBInspectable public var selectedRowColor: UIColor = UIColor.lightGray
    @IBInspectable public var selectedRowTextColor: UIColor = .white
    ...
    public func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: 0.5,
                       animations: { () -> Void in
                        ...
                        tableView.cellForRow(at: indexPath)?.textLabel?.textColor = self.selectedRowTextColor
        } ,
                       completion: { (didFinish) -> Void in
