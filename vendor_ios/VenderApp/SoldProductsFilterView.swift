//
//  SoldProductsFilterview.swift
//  VenderApp
//
//  Created by cedcoss on 28/06/19.
//  Copyright © 2019 CEDCOSS Technologies Private Limited. All rights reserved.
//

import UIKit

class SoldProductsFilterView: UIView {
    ...
    @objc func loadViewFromNib() -> UIView
    {
        ...
        let nib = UINib(nibName: "SoldProductsFilterView", bundle: bundle)
    ...
    @objc func applyFilterTapped(_ sender:UIButton){
        ...
        let to = DateTo.text ?? ""
        let poststring = ["sku":sku,"name":name,"product_type":type,"date_search":["from":from,"to":to]].convtToJson() as String
