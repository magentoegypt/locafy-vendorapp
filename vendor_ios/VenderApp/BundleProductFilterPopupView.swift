...
class BundleProductFilterPopupView: UIView {
    ...
    @IBOutlet weak var value4: UIButton!
    @IBOutlet weak var leftButton: UIButton!
    @IBOutlet weak var rightButton: UIButton!
    
    @IBOutlet weak var second: UILabel!
    
    @IBOutlet weak var secondVal: UITextView!
    ...
    @objc func xibSetup()
    {
      ...
      //  topLabel.backgroundColor = color;
        ...
        PopupLookImprovement.designTextView(secondVal);
    ...
    @objc func loadViewFromNib() -> UIView
    {
        ...
        let nib = UINib(nibName: "BundleProductFilterPopupView", bundle: bundle)
