...
open class DatePickerDialog: UIView {
    ...
    /* Consts */
    fileprivate let kDatePickerDialogDefaultButtonHeight:       CGFloat = 40
    fileprivate let kDatePickerDialogDefaultButtonSpacerHeight: CGFloat = 1
    fileprivate let kDatePickerDialogCornerRadius:              CGFloat = 0
    ...
    open func show(_ title: String, doneButtonTitle: String = "Done", cancelButtonTitle: String = "Cancel", defaultDate: Date = Date(), datePickerMode: UIDatePicker.Mode = .dateAndTime, callback: @escaping DatePickerCallback) {
    ...
    fileprivate func addButtonsToView(_ container: UIView) {
        let buttonWidth = (container.bounds.size.width / 2) - 10;
        ...
        self.cancelButton.setTitleColor(UIColor.white, for: UIControl.State())
    ...
    /* Helper @objc function: count and return the screen's size */
    @objc func countScreenSize() -> CGSize {
