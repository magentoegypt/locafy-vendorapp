//
//  ced_lowStockInventoryViewController.swift
//  VenderApp
//
...
class ced_lowStockInventoryViewController: ced_VendorBaseClass {
    ...
    lazy var topLabel:UIButton = {
        let lbl = UIButton()
        lbl.setTitle("Inventory Low Stock Products".localized, for: .normal)
...
//        lbl.addTarget(self, action: #selector(addNewFaqTapped(_:)), for: .touchUpInside)
    ...
    func getLowStockProducts(){
        ...
        sendRestFullRequest(url: "vinventory/GetLowstockproducts", params: postdata, store: false)
    ...
    override func recieveResponse(data: Data?, requestUrl: String?, response: URLResponse?) {
        ...
        if requestUrl == "vinventory/GetLowstockproducts"{
...
extension ced_lowStockInventoryViewController:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.populate(with: productData[indexPath.row])
        return cell
    }
...
//MARK: - UIGesture
extension ced_lowStockInventoryViewController:UIGestureRecognizerDelegate{
